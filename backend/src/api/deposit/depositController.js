...
getSingleDeposit: async (req, res, next) => {
  ...
  deleteDeposit: async (req, res, next) => {
        ...
        //   const { start, end } = req.query; // Expect start and end dates in query parameters
        ...
        //     // Fetch deposits within the specified date range
        //     const deposits = await prisma.deposits.findMany({
        //       where: {
        //         createdAt: {
        ...
        //     // Initialize an empty object to hold grouped deposits
        //     const groupedDeposits = {};
        
        //     // Iterate over each day in the date range and group deposits
